    ...
    return (
        <>
            ...
            <p className="text-center text-sm text-gray-600 mt-8">
                ...
                <Link href="/signup" className="text-green-600 font-semibold hover:text-green-500 hover:underline transition-colors">
                    Create account
                </Link>
            </p>

            <div className="text-center mt-6">
                <Link href="/" className="inline-flex items-center text-sm font-medium text-gray-500 hover:text-gray-800 transition-colors group">
